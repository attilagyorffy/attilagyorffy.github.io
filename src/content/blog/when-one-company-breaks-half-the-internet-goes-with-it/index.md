---
title: "When One Company Breaks, Half the Internet Goes with It"
subtitle: "Cloudflare's security systems malfunctioned, blocking legitimate users alongside malicious traffic, exposing how Internet infrastructure depends on a handful of companies."
date: 2025-11-21
description: "Cloudflare had a bad day and half the internet went dark. When your security layer blocks legitimate users, you are not protecting anything. You are the outage."
summary: "Cloudflare's security guard got a dodgy guest list and decided to turn everyone away. Half the Internet watched from the car park."
topics:
  - Infrastructure
type: Essay
read_time: "3 min read"
footer: "If you've made it this far without Cloudflare blocking you, congratulations. Come find me on [Bluesky](https://bsky.app/profile/attilagyorffy.com), [Mastodon](https://fosstodon.org/@attila), [~~Twitter~~ X](https://twitter.com/attilagyorffy), or [LinkedIn](https://linkedin.com/in/attilagyorffy) if you fancy discussing internet fragility in a place that somehow runs on its own infrastructure. Code lives on [GitHub](https://github.com/attilagyorffy), where at least the outages are my own fault."
---
...
And because Cloudflare stands in front of so many major websites, this failure meant that a huge number of sites suddenly blocked all visitors. From the outside, it looked as though a significant part of the Internet had gone down. <mark>When so many sites rely on the same service, a disruption like this is similar to shutting down one of the world's busiest highway intersections: everything connected to it becomes unreachable at once.</mark>
